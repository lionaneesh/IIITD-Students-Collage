...
(function (factory) {
    ...
    $.extend($.fn.modal.Constructor.prototype, {
        ...
        loadImage: function () {
            ...
            var websites = $(this.$links[index]).data("websites");
            var bio      = $(this.$links[index]).data("bio");
            var location = $(this.$links[index]).data("location");  
            var modal_links = modal.find('.modal-links');
            var modal_bio = modal.find('.modal-bio');
            var modal_location = modal.find('.modal-location');
            modal_links.html(""); // clear up the area
            var ul = $("<ul>")            
            for (var key in websites) {
                if (websites[key] != "") {
                   ul.append($("<li><a href='" + websites[key] + "'>" + key + "</a></li>"))
                }
            }
            modal_links.append(ul)
            
            modal_bio.html("")
            modal_bio.html("<p>" + bio + "</p>")
